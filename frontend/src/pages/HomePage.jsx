                ...
                return (
                  ...
                  >
                    <div className="card-body p-5 space-y-4">
                      ...
                      {/*LANGUAGES WITH FLAGS;  here capitalize is used to make first letter capital of the language*/}
                      <div className="flex flex-wrap gap-1.5">
                        ...
                        <span className="badge badge-outline">
                          ...
                          Native: {capitalize(user.learningLanguage)}
                        </span>
                      </div>

                      {user.bio && (
                        <p className="text-sm opcaity-70">{user.bio}</p>
                      )}
